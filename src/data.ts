...
export const defaultOSConfig: OSConfig = {
  ...
  portfolioBio: 'Architekt systemów full-stack, twórca immersyjnych interfejsów webowych i pasjonat sztucznej inteligencji. Przekształcam złożone wymagania biznesowe w eleganckie, wydajne i skalowalne aplikacje chmurowe.',
  githubUsername: 'krymszuch-stack',
  linkedinUsername: 'in/adrianowicz',
  instagramUsername: 'adrian.dev',
  instagramPhotos: [
  ...
  iconStyleModern: 'lumine-minimalist-glass',
