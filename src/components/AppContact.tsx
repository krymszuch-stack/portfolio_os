        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[1000] p-4">
          <div className="w-full max-w-sm bg-slate-950 border border-slate-800 rounded-2xl p-5 shadow-2xl space-y-4 animate-fadeIn">
            ...
            <div className="flex gap-2 justify-end">
              <button
                onClick={() => handleSaveSocial(editingPlatform)}
                className="px-3.5 py-1.5 bg-amber-500 hover:bg-amber-600 text-slate-950 text-xs font-sans font-bold rounded-lg cursor-pointer transition-colors"
              >
                Zapisz
              </button>
              <button
                onClick={() => setEditingPlatform(null)}
                className="px-3.5 py-1.5 bg-slate-800 hover:bg-slate-700 text-slate-300 text-xs font-sans rounded-lg cursor-pointer transition-colors"
              >
                Anuluj
              </button>
            </div>
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="grid grid-cols-4 gap-3">
            ...
            {config?.githubUsername ? (
              <div className="flex flex-col items-center justify-center p-3 rounded-xl bg-slate-900/40 border border-slate-800/80 hover:border-slate-500/30 transition-all duration-300 group text-center relative">
                ...
                >
                  ...
                  <span className="text-[10px] text-slate-300 font-bold mt-1.5 group-hover:text-white truncate max-w-full">
                    {config.githubUsername}
                  </span>
                </a>
                <button
              ...
              <button
                onClick={() => handleOpenEditor('githubUsername', '')}
                className="flex flex-col items-center justify-center p-3 rounded-xl bg-amber-500/5 hover:bg-amber-500/15 border-2 border-dashed border-amber-500/20 hover:border-amber-400/50 transition-all duration-300 text-center relative group cursor-pointer shadow-[0_0_12px_rgba(245,158,11,0.08)] hover:shadow-[0_0_20px_rgba(245,158,11,0.25)] animate-pulse"
              >
                ...
                <span className="text-[9px] text-amber-300 font-bold mt-2 uppercase tracking-wider">GitHub</span>
              </button>
            )}
            ...
            {config?.gitlabUsername ? (
              ...
              <button
                onClick={() => handleOpenEditor('gitlabUsername', '')}
                className="flex flex-col items-center justify-center p-3 rounded-xl bg-amber-500/5 hover:bg-amber-500/15 border-2 border-dashed border-amber-500/20 hover:border-amber-400/50 transition-all duration-300 text-center relative group cursor-pointer shadow-[0_0_12px_rgba(245,158,11,0.08)] hover:shadow-[0_0_20px_rgba(245,158,11,0.25)] animate-pulse"
              >
                <div className="w-8 h-8 rounded-full bg-amber-500/10 flex items-center justify-center text-amber-400 group-hover:scale-110 transition-transform">
                  <Plus size={16} />
                </div>
                <span className="text-[9px] text-amber-300 font-bold mt-2 uppercase tracking-wider">GitLab</span>
              </button>
            )}
            ...
            {config?.linkedinUsername ? (
              ...
              <button
                onClick={() => handleOpenEditor('linkedinUsername', '')}
                className="flex flex-col items-center justify-center p-3 rounded-xl bg-amber-500/5 hover:bg-amber-500/15 border-2 border-dashed border-amber-500/20 hover:border-amber-400/50 transition-all duration-300 text-center relative group cursor-pointer shadow-[0_0_12px_rgba(245,158,11,0.08)] hover:shadow-[0_0_20px_rgba(245,158,11,0.25)] animate-pulse"
              >
                <div className="w-8 h-8 rounded-full bg-amber-500/10 flex items-center justify-center text-amber-400 group-hover:scale-110 transition-transform">
                  <Plus size={16} />
                </div>
                <span className="text-[9px] text-amber-300 font-bold mt-2 uppercase tracking-wider">LinkedIn</span>
              </button>
            )}
            ...
            {config?.instagramUsername ? (
              ...
              <button
                onClick={() => handleOpenEditor('instagramUsername', '')}
                className="flex flex-col items-center justify-center p-3 rounded-xl bg-amber-500/5 hover:bg-amber-500/15 border-2 border-dashed border-amber-500/20 hover:border-amber-400/50 transition-all duration-300 text-center relative group cursor-pointer shadow-[0_0_12px_rgba(245,158,11,0.08)] hover:shadow-[0_0_20px_rgba(245,158,11,0.25)] animate-pulse"
              >
                <div className="w-8 h-8 rounded-full bg-amber-500/10 flex items-center justify-center text-amber-400 group-hover:scale-110 transition-transform">
                  <Plus size={16} />
                </div>
                <span className="text-[9px] text-amber-300 font-bold mt-2 uppercase tracking-wider">Instagram</span>
              </button>
            )}
            ...
            {config?.facebookUsername ? (
              ...
              <button
                onClick={() => handleOpenEditor('facebookUsername', '')}
                className="flex flex-col items-center justify-center p-3 rounded-xl bg-amber-500/5 hover:bg-amber-500/15 border-2 border-dashed border-amber-500/20 hover:border-amber-400/50 transition-all duration-300 text-center relative group cursor-pointer shadow-[0_0_12px_rgba(245,158,11,0.08)] hover:shadow-[0_0_20px_rgba(245,158,11,0.25)] animate-pulse"
              >
                <div className="w-8 h-8 rounded-full bg-amber-500/10 flex items-center justify-center text-amber-400 group-hover:scale-110 transition-transform">
                  <Plus size={16} />
                </div>
                <span className="text-[9px] text-amber-300 font-bold mt-2 uppercase tracking-wider">Facebook</span>
              </button>
            )}
            ...
            {config?.messengerUsername ? (
              ...
              <button
                onClick={() => handleOpenEditor('messengerUsername', '')}
                className="flex flex-col items-center justify-center p-3 rounded-xl bg-amber-500/5 hover:bg-amber-500/15 border-2 border-dashed border-amber-500/20 hover:border-amber-400/50 transition-all duration-300 text-center relative group cursor-pointer shadow-[0_0_12px_rgba(245,158,11,0.08)] hover:shadow-[0_0_20px_rgba(245,158,11,0.25)] animate-pulse"
              >
                <div className="w-8 h-8 rounded-full bg-amber-500/10 flex items-center justify-center text-amber-400 group-hover:scale-110 transition-transform">
                  <Plus size={16} />
                </div>
                <span className="text-[9px] text-amber-300 font-bold mt-2 uppercase tracking-wider">Messenger</span>
              </button>
            )}
            ...
            {config?.telegramUsername ? (
              ...
              <button
                onClick={() => handleOpenEditor('telegramUsername', '')}
                className="flex flex-col items-center justify-center p-3 rounded-xl bg-amber-500/5 hover:bg-amber-500/15 border-2 border-dashed border-amber-500/20 hover:border-amber-400/50 transition-all duration-300 text-center relative group cursor-pointer shadow-[0_0_12px_rgba(245,158,11,0.08)] hover:shadow-[0_0_20px_rgba(245,158,11,0.25)] animate-pulse"
              >
                <div className="w-8 h-8 rounded-full bg-amber-500/10 flex items-center justify-center text-amber-400 group-hover:scale-110 transition-transform">
                  <Plus size={16} />
                </div>
                <span className="text-[9px] text-amber-300 font-bold mt-2 uppercase tracking-wider">Telegram</span>
              </button>
            )}
            ...
            {config?.whatsappPhone ? (
              ...
              <button
                onClick={() => handleOpenEditor('whatsappPhone', '')}
                className="flex flex-col items-center justify-center p-3 rounded-xl bg-amber-500/5 hover:bg-amber-500/15 border-2 border-dashed border-amber-500/20 hover:border-amber-400/50 transition-all duration-300 text-center relative group cursor-pointer shadow-[0_0_12px_rgba(245,158,11,0.08)] hover:shadow-[0_0_20px_rgba(245,158,11,0.25)] animate-pulse"
              >
                <div className="w-8 h-8 rounded-full bg-amber-500/10 flex items-center justify-center text-amber-400 group-hover:scale-110 transition-transform">
                  <Plus size={16} />
                </div>
                <span className="text-[9px] text-amber-300 font-bold mt-2 uppercase tracking-wider">WhatsApp</span>
              </button>
            )}
          ...
          <div className="pt-4 border-t border-slate-800 space-y-3">
            ...
            <div className="pl-4 border-l-2 border-purple-500/20 ml-2 space-y-2.5">
              ...
              {config?.steamId ? (
                <div className="p-3 rounded-xl bg-slate-900/15 border border-slate-800/60 hover:border-[#00adee]/30 flex items-center justify-between group relative">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-slate-400 font-mono">{config.steamId}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-1.5 shrink-0 z-10">
                    <button
                      onClick={() => handleOpenEditor('steamId', config.steamId || '')}
                ...
                <button
                  onClick={() => handleOpenEditor('steamId', '')}
                  className="w-full p-3 rounded-xl bg-amber-500/5 hover:bg-amber-500/10 border-2 border-dashed border-amber-500/20 hover:border-amber-400/50 flex items-center justify-between transition-all duration-300 group cursor-pointer shadow-[0_0_8px_rgba(245,158,11,0.05)] animate-pulse"
                >
                  <div className="flex items-center space-x-3">
                    <div className="w-8 h-8 rounded-full bg-amber-500/10 flex items-center justify-center text-amber-400 group-hover:scale-110 transition-transform">
                      <Plus size={14} />
                    </div>
                    <span className="text-xs font-sans font-bold text-amber-300 uppercase tracking-widest text-left">Dodaj Steam</span>
                  </div>
                </button>
              )}
              ...
              {config?.eaId ? (
                <div className="p-3 rounded-xl bg-slate-900/15 border border-slate-800/60 hover:border-[#ff134b]/30 flex items-center justify-between group relative">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-slate-400 font-mono">{config.eaId}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-1.5 shrink-0 z-10">
                    <button
                      onClick={() => handleOpenEditor('eaId', config.eaId || '')}
                      className="text-[10px] text-slate-400 hover:text-amber-400 cursor-pointer"
                    >
                      Zmień
                    </button>
                    <span className="text-[9px] text-[#ff134b] font-mono font-bold">
                      EA APP
                    </span>
                  </div>
                </div>
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-xs font-sans font-bold text-amber-300 uppercase tracking-widest text-left">Dodaj EA ID</span>
                  </div>
                </button>
              )}
              ...
              {config?.ubiId ? (
                <div className="p-3 rounded-xl bg-slate-900/15 border border-slate-800/60 hover:border-[#00ffff]/30 flex items-center justify-between group relative">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-slate-400 font-mono">{config.ubiId}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-1.5 shrink-0 z-10">
                    <button
                      onClick={() => handleOpenEditor('ubiId', config.ubiId || '')}
                      className="text-[10px] text-slate-400 hover:text-amber-400 cursor-pointer"
                    >
                      Zmień
                    </button>
                    <span className="text-[9px] text-[#00ffff] font-mono font-bold">
                      CONNECT
                    </span>
                  </div>
                </div>
                ...
                <button
                  onClick={() => handleOpenEditor('ubiId', '')}
                  className="w-full p-3 rounded-xl bg-amber-500/5 hover:bg-amber-500/10 border-2 border-dashed border-amber-500/20 hover:border-amber-400/50 flex items-center justify-between transition-all duration-300 group cursor-pointer shadow-[0_0_8px_rgba(245,158,11,0.05)] animate-pulse"
                >
                  <div className="flex items-center space-x-3">
                    <div className="w-8 h-8 rounded-full bg-amber-500/10 flex items-center justify-center text-amber-400 group-hover:scale-110 transition-transform">
                    ...
                    <span className="text-xs font-sans font-bold text-amber-300 uppercase tracking-widest text-left">Dodaj Ubisoft</span>
                  </div>
                </button>
              )}
              ...
              {config?.discordId ? (
                <div className="p-3 rounded-xl bg-slate-900/15 border border-slate-800/60 hover:border-[#5865F2]/30 flex items-center justify-between group relative">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h5 className="text-xs font-sans font-bold text-white group-hover:text-[#5865F2] transition-colors">Discord Username</h5>
                      <p className="text-[10px] text-slate-400 font-mono">{config.discordId}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-1.5 shrink-0 z-10">
                    <button
                      onClick={() => handleOpenEditor('discordId', config.discordId || '')}
                      className="text-[10px] text-slate-400 hover:text-amber-400 cursor-pointer"
                    >
                      Zmień
                    </button>
                ...
                <button
                  onClick={() => handleOpenEditor('discordId', '')}
                  className="w-full p-3 rounded-xl bg-amber-500/5 hover:bg-amber-500/10 border-2 border-dashed border-amber-500/20 hover:border-amber-400/50 flex items-center justify-between transition-all duration-300 group cursor-pointer shadow-[0_0_8px_rgba(245,158,11,0.05)] animate-pulse"
                >
                  <div className="flex items-center space-x-3">
                    <div className="w-8 h-8 rounded-full bg-amber-500/10 flex items-center justify-center text-amber-400 group-hover:scale-110 transition-transform">
                    ...
                    <span className="text-xs font-sans font-bold text-amber-300 uppercase tracking-widest text-left">Dodaj Discord</span>
                  </div>
                </button>
              )}
